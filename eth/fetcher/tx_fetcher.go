...
import (
	...
	"github.com/pioplat/pioplat-core/common/gopool"
...
type PioplatBroadcastBlockFn func(*types.Transaction)
...
type TxFetcher struct {
	...
	pioplatBroadcastTx PioplatBroadcastBlockFn
}

// NewTxFetcher creates a transaction fetcher to retrieve transaction
// based on hash announcements.
func NewTxFetcher(hasTx func(common.Hash) bool, addTxs func([]*types.Transaction) []error, fetchTxs func(string, []common.Hash) error, pioplatBroadcast PioplatBroadcastBlockFn) *TxFetcher {
	return NewTxFetcherForTests(hasTx, addTxs, fetchTxs, mclock.System{}, nil, pioplatBroadcast)
}
...
func NewTxFetcherForTests(
	...
	clock mclock.Clock, rand *mrand.Rand, pioplatBroadcast PioplatBroadcastBlockFn) *TxFetcher {
	return &TxFetcher{
		...
		clock:              clock,
		rand:               rand,
		pioplatBroadcastTx: pioplatBroadcast,
	}
}
...
func (f *TxFetcher) Enqueue(peer string, txs []*types.Transaction, direct bool) error {
	...
	select {
	// direct: Whether this is a direct reply or a broadcast
